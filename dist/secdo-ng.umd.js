(function (global, factory) {
	...
	(factory((global['secdo-ng'] = {}),global.platformBrowser,global.core,global.forms));
...
var BaseResponseOptions = (function (_super) {
    __extends$3(BaseResponseOptions, _super);
...
var CookieXSRFStrategy = (function () {
    ...
    CookieXSRFStrategy.prototype.configureRequest = function (req) {
        var /** @type {?} */ xsrfToken = platformBrowser.__platform_browser_private__.getDOM().getCookie(this._cookieName);
        if (xsrfToken) {
...
var BaseRequestOptions = (function (_super) {
    __extends$5(BaseRequestOptions, _super);
...
var SecdoNgService = (function () {
    function SecdoNgService() {
        this.emptyTextDisplay = "from service";
    }
    SecdoNgService.prototype.get = function () {
        return this.emptyTextDisplay;
    };
    SecdoNgService.prototype.set = function (emptyTextDisplay) {
        this.emptyTextDisplay = emptyTextDisplay;
    };
    SecdoNgService = __decorate([
        core.Injectable(), 
        __metadata('design:paramtypes', [])
    ], SecdoNgService);
    return SecdoNgService;
}());

var SecdoNgComponent = (function () {
    function SecdoNgComponent(appsrvc) {
        this.appsrvc = appsrvc;
        this.title = 'app works! ';
    }
    SecdoNgComponent.prototype.ngOnInit = function () {
        this.title += this.appsrvc.get();
    };
    SecdoNgComponent = __decorate([
        core.Component({
            selector: 'secdo-ng',
            template: "<h1>\n  {{title}} <br>\n  is it?\n</h1>\n",
            styles: [""]
        }), 
        __metadata('design:paramtypes', [(typeof (_a = typeof SecdoNgService !== 'undefined' && SecdoNgService) === 'function' && _a) || Object])
    ], SecdoNgComponent);
    return SecdoNgComponent;
    var _a;
}());

var SecdoNgModule = (function () {
    function SecdoNgModule() {
    }
    SecdoNgModule = __decorate([
        core.NgModule({
    ...
    return SecdoNgModule;
}());

exports.SecdoNgModule = SecdoNgModule;
exports.SecdoNgComponent = SecdoNgComponent;
exports.SecdoNgService = SecdoNgService;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=secdo-ng.umd.js.map
